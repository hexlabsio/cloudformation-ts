...
export function clientAuthenticationRequestProps(clientAuthenticationRequestPropsProps: ClientAuthenticationRequestProps): ClientAuthenticationRequestProps { return (clientAuthenticationRequestPropsProps) }
