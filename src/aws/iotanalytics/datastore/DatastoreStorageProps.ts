...
export function datastoreStorageProps(datastoreStoragePropsProps: DatastoreStorageProps): DatastoreStorageProps { return (datastoreStoragePropsProps) as unknown as DatastoreStorageProps }
